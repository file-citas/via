...
static const char __UNIQUE_ID(name)[]					  \
  __used __attribute__((no_sanitize("address"), section(".modinfo"), unused, aligned(1)))	  \
...
#define __module_param_call(prefix, name, ops, arg, perm, level, flags)	\
	...
	__used								\
    __section("__param") __attribute__ ((no_sanitize("address"), unused, aligned(sizeof(void *)))) \
