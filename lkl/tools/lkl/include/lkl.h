...
int lkl_netlink_sock(unsigned int groups);
int iprule_modify_sock(int cmd, int ifindex, int af, void *saddr, int fd);
int iproute_modify_sock(int cmd, unsigned int flags, int ifindex, int af,
		void *route_addr, int route_masklen, void *gwaddr, int fd);
int ipaddr_modify_sock(int cmd, int flags, int ifindex, int af, void *addr,
			 unsigned int netprefix_len, int fd);
/**
...
// FUZZER STUFF //////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////
extern int fuzz_last_probe_status;
//void *usb_xhci_realize();
//void *usb_hub_realize();
//void attach_usb_device(void *xhci);
//void init_usb_device();
// debug options
struct fuzz_debug_options {
   int mod;
   int io;
   int irq;
   int msiirq;
...
int* lkl_fuzz_get_snok_ptr(void);
int* lkl_fuzz_get_sok_ptr(void);
...
void lkl_fuzz_set_count_syscalls(int set);
...
int lkl_fuzz_send_to_rx(int id);
int lkl_fuzz_netdev_add(struct lkl_netdev *nd, struct lkl_netdev_args* args);
