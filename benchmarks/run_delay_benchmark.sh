...
#python3 $VIA_BEVAL_DIR/run_bench.py -targetfn $VIA_BEVAL_DIR/target_drvs -time $VIA_B_TIME -timeout 120 -runs $VIA_B_RUNS -workers $VIA_B_WORKERS -target_irqs 1 -update_hwm 1 -patch_level 2 -apply_hacks 0 -min_delay 0  -fast_irqs 0 > $VIA_BRESULT_DIR/via_d.log
...
#python3 $VIA_BEVAL_DIR/run_bench.py -targetfn $VIA_BEVAL_DIR/target_drvs -time $VIA_B_TIME -timeout 120 -runs $VIA_B_RUNS -workers $VIA_B_WORKERS -target_irqs 1 -update_hwm 1 -patch_level 2 -apply_hacks 0 -min_delay 1 -fast_irqs 0 > $VIA_BRESULT_DIR/via_nd.log
...
python3 $VIA_BEVAL_DIR/eval_bench.py -data $VIA_BRESULT_DIR/via_d.json $VIA_BRESULT_DIR/via_nd.json -confkey _tiq1_wait1-1000_hck1_pt11_pt21_del0 _tiq1_wait1-1000_hck1_pt11_pt21_del1 -key cov | tee $VIA_BRESULT_DIR/delay_cov.res
...
python3 $VIA_BEVAL_DIR/eval_bench.py -data $VIA_BRESULT_DIR/via_d.json $VIA_BRESULT_DIR/via_nd.json -confkey _tiq1_wait1-1000_hck1_pt11_pt21_del0 _tiq1_wait1-1000_hck1_pt11_pt21_del1 -key avg_execs | tee $VIA_BRESULT_DIR/delay_avg_execs.res
