...
uptr __asan_MemToShadow(uptr ptr) {
  return MemToShadow(ptr);
}

extern "C" SANITIZER_INTERFACE_ATTRIBUTE
bool __asan_AddressIsPoisoned(uptr a) {
  return AddressIsPoisoned(a);
}

extern "C" SANITIZER_INTERFACE_ATTRIBUTE
bool __asan_AddrIsInShadow(uptr a) {
  return AddrIsInShadow(a);
}
